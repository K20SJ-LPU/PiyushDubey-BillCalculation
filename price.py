...
label4 = Label(left1, font = ('arial',50,'bold'), text ="Change Price", fg = "light green", bd = 10, anchor = 'w')
label4.grid(row = 0)
...
txt_fries = Entry(left1,font=('arial',16,'bold'), textvariable=fries_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
...
txt_samosa = Entry(left1,font=('arial',16,'bold'), textvariable=samosa_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
...
txt_burger = Entry(left1,font=('arial',16,'bold'), textvariable=burger_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
...
txt_drinks = Entry(left1,font=('arial',16,'bold'), textvariable=drinks_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
txt_drinks.grid(row=4,column=1)

paneer_tikka = Label(left1, font=('arial',16,'bold'),text = "Paneer Butter Masala", bd = 16, anchor = 'w' )
paneer_tikka.grid(row=5,column=0,sticky = E)
txt_paneer_tikka = Entry(left1,font=('arial',16,'bold'), textvariable=paneer_tikka_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
txt_paneer_tikka.grid(row=5,column=1)

chicken_tikka = Label(left1, font=('arial',16,'bold'),text = "Chicken Lolipop", bd = 16, anchor = 'w' )
chicken_tikka.grid(row=6,column=0,sticky = E)
txt_chicken_tikka = Entry(left1,font=('arial',16,'bold'), textvariable=chicken_tikka_inp_p, bd=10, insertwidth =4,bg = "yellow", justify ='right')
txt_chicken_tikka.grid(row=6,column=1)


btn_update = Button(left1, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Update", bg= "crimson",command = update)
btn_update.grid(row=7, column= 1)

btn_reset1 = Button(left1, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Reset", bg= "crimson",command = reset1)
btn_reset1.grid(row=7, column= 2)

btn_exit1 = Button(left1, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Exit", bg= "crimson",command = qexit1)
btn_exit1.grid(row=7, column= 3)

btn_print = Button(left1, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "print", bg= "sky blue",command = printfn)
btn_print.grid(row=7, column= 4)

btn_back = Button(left1, padx= 16, pady= 8, bd= 16, fg= "black", font=('arial',16,'bold'), width=10, text= "Back", bg= "pink",command = backfn)
